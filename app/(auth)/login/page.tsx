  ...
  return (
    <div className="flex flex-col items-center justify-center  h-screen p-6">
      ...
      <div className="flex items-center justify-center mt-5 ">
        <p className={`${inter.className} font-medium text-[14px] text-slate-500 mb-5`}>Don't have an account yet? <Link href="/signup" className={`${inter.className} font-normal text-blue-500`}>Sign up</Link></p>
      </div>
    </div>
  )
}