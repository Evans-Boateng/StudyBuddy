...
export default function Home() {
  return (
    <div className="">
      ...
      <div className="mt-8 px-7 lg:px-[120px] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {
          features.map((step, index) => {
            return (
              <div className="flex flex-col  justify-center bg-white p-3 rounded-lg shadow" key={index}>
                {/* <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="icon text-indigo-500" style="" width="1em" height="1em" viewBox="0 0 576 512" data-v-e8d572f6="">
                ...
                <h3 className={`${poppins.className} mb-1 text-4 font-semibold`}>
